...
public class Profile extends javax.swing.JFrame {
  ...
  private void profile_info(){
     ...
     private void MostrarFoto(){
        ...
        try {
           /* String query1 = "SELECT DISTINCT p.post_text, p.post_type, i.image_data " +
                    "FROM Posts p" +
                    " LEFT JOIN Images i ON p.post_id = i.post_id" +
                    "WHERE p.user_id = ?";*/
            String query1 = "SELECT DISTINCT p.user_id, i.image_data\n" +
                           "FROM Posts p \n" +
                           "LEFT JOIN Images i ON p.post_id = i.post_id \n" +
                           "WHERE p.user_id = ?";
            
            PreparedStatement statement = this.connection.prepareStatement(query1, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
            statement.setInt(1, id); // Asignar el ID de usuario al primer parámetro
...
private static ImageIcon bytesToImageIcon(byte[] multimedia) {
    ...
    try {
        if (resultSet.next()) { 
          ...
          ImageIcon imageIcon = bytesToImageIcon(imagen);
                if (imageIcon != null) {
                    this.lbl_Cover.setIcon(imageIcon);
                } else {
    ...
    private void initComponents() {
        ...
        btn_Friends = new javax.swing.JButton();
        btn_ImagesUser = new javax.swing.JButton();
        btn_VideosUser = new javax.swing.JButton();
        ...
        btn_ImagesUser.setBackground(new java.awt.Color(255, 153, 204));
        btn_ImagesUser.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btn_ImagesUser.setText("Fotos");
        btn_ImagesUser.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_ImagesUserActionPerformed(evt);
            }
        });

        btn_VideosUser.setBackground(new java.awt.Color(255, 153, 204));
        btn_VideosUser.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btn_VideosUser.setText("Videos");
        btn_VideosUser.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_VideosUserActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addGap(82, 82, 82)
                                    .addComponent(btn_ImagesUser)
                                    .addGap(88, 88, 88)
                                    .addComponent(btn_VideosUser)
                                    .addGap(75, 75, 75))))
                        .addGap(117, 117, 117))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btn_ImagesUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ImagesUserActionPerformed
        User_Images User_Images= new User_Images(id);
      User_Images.setVisible(true);
        this.setVisible(false);
        
    }//GEN-LAST:event_btn_ImagesUserActionPerformed
    ...
    private void btn_VideosUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_VideosUserActionPerformed
        /* User_Videos User_Videos = new User_Videos(id);
        User_Videos.setVisible(true);
        this.setVisible(false);*/
    }//GEN-LAST:event_btn_VideosUserActionPerformed
    ...
    private javax.swing.JButton btn_ImagesUser;
    private javax.swing.JButton btn_Post;
    private javax.swing.JButton btn_VideosUser;
